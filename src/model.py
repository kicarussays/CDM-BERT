...
class BertModelLabelAdded(BertModel):
    ...
    def forward(
        ...
        label_type_ids: Optional[torch.Tensor] = None,
        ...
        if label_type_ids is None:
            if hasattr(self.embeddings, "label_type_ids"):
                buffered_label_type_ids = self.embeddings.label_type_ids[:, :seq_length]
                buffered_label_type_ids_expanded = buffered_label_type_ids.expand(batch_size, seq_length)
                label_type_ids = buffered_label_type_ids_expanded
            else:
                label_type_ids = torch.zeros(input_shape, dtype=torch.long, device=device)
